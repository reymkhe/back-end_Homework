...
public class GrepFactory {
     ...
     * @return OneWordGrep
     */
    public static OneWordGrep getOneWordGrep(final String filter) {
     ...
     * @return OrGrep
     */
    public static OrGrep getOrGrep(final String filter1, final String filter2) {
     ...
     * @return AndGrep
     */
    public static AndGrep getAndGrep(final String filter1, final String filter2) {
